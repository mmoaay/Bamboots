...
class EyeLoading: UIView, Maskable {

    var maskId: String = "EyeLoading"
...
// TODO: build        self.backgroundColor = UIColor(colorLiteralRed: 0.0/255.0, green: 138.0/255.0, blue: 241.0/255.0, alpha: 1)
//
