...
class MBEyeLoading: UIView , MBMaskable{
    ...
    */
    ...
    init() {
        ...
        self.backgroundColor = UIColor(colorLiteralRed: 73.0/255.0, green: 148.0/255.0, blue: 241.0/255.0, alpha: 1)
        
        eyelidView.backgroundColor = UIColor.white
        
        eyeballView.backgroundColor = UIColor(colorLiteralRed: 73.0/255.0, green: 148.0/255.0, blue: 241.0/255.0, alpha: 1)
    ...
    private func animationForEyelid(duration: TimeInterval, beginTime: TimeInterval = 0.0, marginTop: CGFloat, marginBottom: CGFloat) -> CABasicAnimation {
    ...
    private func positionAnimationForEyeballPath(duration: TimeInterval, beginTime: TimeInterval = 0.0, offset:CGFloat) -> CABasicAnimation {
    ...
    private func scaleAnimationForEyeballPath(duration: TimeInterval, beginTime: TimeInterval = 0.0, height:CGFloat) -> CABasicAnimation {
    ...
    private func rotateAnimationForWhitesPath(duration: TimeInterval, beginTime: TimeInterval = 0.0) -> CABasicAnimation {
    ...
    private func getEyelidPath(marginTop: CGFloat, marginBottom: CGFloat) -> CGPath{
        ...
        path.addCurve(to: CGPoint(x: eyelidView.width, y: 28), controlPoint1: controlPointTopOne, controlPoint2: controlPointTopTwo)
        path.addCurve(to: CGPoint(x: 0, y: 28), controlPoint1: controlPointBottomOne, controlPoint2: controlPointBottomTwo)
